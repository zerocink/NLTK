...
// CONSTANTES :
//---------------------------------------------------------------------------
#define TXT_TRUE   AnsiString( "T" )
#define TXT_FALSE  AnsiString( "F" )
//===========================================================================
...
// CLASSE CDBEngine
//---------------------------------------------------------------------------
AnsiString __fastcall CDBEngine::boolToString( bool b )
{
    if ( b ) return TXT_TRUE;
    return TXT_FALSE;
}
//---------------------------------------------------------------------------
bool __fastcall CDBEngine::stringToBool( AnsiString s )
{
