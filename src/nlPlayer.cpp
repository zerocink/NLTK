...
{
    ps._GM = this->SeasonGM;
    ps._GMS = this->SeasonGMS;
    ps._FGM = this->SeasonFGM;
    ps._FGA = this->SeasonFGA;
    ps._TPM = this->Season3PM;
    ps._TPA = this->Season3PA;
    ps._FTM = this->SeasonFTM;
    ps._FTA = this->SeasonFTA;
    ps._ORB = this->SeasonORB;
    ps._DRB = this->SeasonDRB;
    ps._AST = this->SeasonAST;
    ps._STL = this->SeasonSTL;
    ps._BLK = this->SeasonBLK;
    ps._TO = this->SeasonTO;
    ps._FLS = this->SeasonFLS;
    ps._MIN = this->SeasonMIN;
    ps._EJT = this->SeasonEJT;
}
//---------------------------------------------------------------------------
